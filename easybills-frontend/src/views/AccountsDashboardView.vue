    ...
    <div class="main-content">
      ...
      <div class="content-wrapper">
        ...
        <div class="stats-grid">
          ...
          <div class="stat-card red" @click="applyFilter('rejected')">
            <div class="stat-icon">❌</div>
            <div class="stat-info">
...
.year-card .stat-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 0.5rem; }
.year-select { padding: 4px; border-radius: 4px; border: 1px solid #ddd; font-size: 0.8rem; cursor: pointer; }

/* TABLE SECTION */
.table-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; }
.table-header h2 { font-size: 1.2rem; color: #333; font-weight: 700; }
.btn-secondary { background: white; border: 1px solid #ddd; padding: 6px 12px; border-radius: 6px; cursor: pointer; }
...
.btn-approve, .btn-reject, .btn-info, .btn-pay {
  width: 30px; height: 30px; border: none; border-radius: 6px; cursor: pointer; display: flex; align-items: center; justify-content: center; font-weight: bold;
}
...
.btn-info:hover { background: #ea580c; color: white; }
