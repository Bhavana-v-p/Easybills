...
// 👇 Use Sequelize Session Store (Since you removed Redis)
...
const app = express();
const PORT = process.env.PORT || 3000; // Define PORT at the top level
...
const sessionMiddleware = session({
    store: sessionStore, // Use Postgres instead of MemoryStore
