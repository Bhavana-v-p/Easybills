...
// 4. Session Setup
// (Using MemoryStore for simplicity to get it working immediately. 
// You can swap this for Redis later if needed)
...
// 5. Passport Config
require('./config/passport'); // Ensure this file exists
